...
describe("feedback helpers", () => {
  test("drops malformed feedback records", () => {
    expect(normalizeFeedbackItems([
      { id: "ok", createdAt: "now", resultName: "paracetamol", status: "correct", feedback: "correct" },
  ...
  test("exports feedback with metadata for review data", () => {
    const exported = buildFeedbackExport([
      { id: "ok", createdAt: "now", resultName: "paracetamol", status: "correct", feedback: "incorrect" },
    ])

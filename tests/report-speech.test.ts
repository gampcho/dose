...
describe("buildReportSpeech", () => {
  ...
  test("summarizes missing, extra, unclear, and manual-check items", () => {
    const speech = buildReportSpeech({
      ...
      status: "fail",
      results: [
        { classId: 1, name: "paracetamol", expected: 2, detected: 1, confidence: 0.9, unit: "viên", status: "missing" },
        { classId: 2, name: "atoris", expected: 0, detected: 1, confidence: 0.9, unit: "viên", status: "extra" },
        { classId: 3, name: "renapril", expected: 1, detected: 1, confidence: 0.4, unit: "viên", status: "unclear" },
      ],
      unknownMeds: [{
        id: "unknown",
        name: "DIAMICRON",
